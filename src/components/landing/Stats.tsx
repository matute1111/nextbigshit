...
const Stats = () => {
  ...
  const GUAPO: Metric[] = [
    { target: 4.5, prefix: "+", suffix: "M", decimals: 1, label: "Views Instagram" },
    { target: 9.5, suffix: "%", decimals: 1, label: "Engagement rate" },
    { target: 30, suffix: "%", label: "Crecimiento followers semanal" },
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-14 md:mb-20 relative">
          ...
          <div
            ref={capyRef}
            className="pointer-events-none absolute -right-[60px] md:-right-[100px] bottom-[calc(-60%+120px)] md:bottom-[calc(-60%+100px)] w-[99%] sm:w-[80%] md:w-[77%] lg:w-[67%] max-w-[1032px] z-0 overflow-visible"
          >
            <img
              src={guapoCapybara}
