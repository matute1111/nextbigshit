    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-14 md:mb-20 relative">
          ...
          <div
            ref={capyRef}
            className="pointer-events-none absolute -right-[60px] md:-right-[100px] bottom-[calc(-60%+120px)] md:bottom-auto md:top-0 w-[99%] sm:w-[80%] md:w-[77%] lg:w-[67%] max-w-[1032px] z-0 overflow-visible"
          >
            <img
              src={guapoCapybara}
