  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="max-w-3xl mx-auto text-center text-lg md:text-xl text-foreground/90 leading-relaxed">
          <span className="text-primary italic font-display uppercase">
            {t("micro.impact.lead")}
          </span>{" "}
          {t("micro.impact.body")}
        </p>
