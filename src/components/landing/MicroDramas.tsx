    ...
    >
      ...
      <div ref={reveal.ref} className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          <div
            ref={handsRef}
            className="hidden md:flex pointer-events-none absolute inset-x-0 -top-[28rem] lg:-top-[34rem] justify-center z-0 overflow-visible"
          >
            <img
              src={microdramaHands}
              alt="Tres manos sosteniendo teléfonos con escenas de microdramas"
              className="block w-[70vw] max-w-[820px] h-auto object-contain will-change-transform drop-shadow-[0_30px_60px_rgba(0,0,0,0.5)]"
