  ...
  return (
    <section className="relative min-h-[100svh] w-full flex flex-col justify-between pt-32 pb-4 md:pt-40 md:pb-8 gap-3 md:gap-6 overflow-hidden bg-gradient-to-b from-background-deeper via-background to-background">
      ...
      <div
        ...
        className="relative z-10 px-6 md:px-10 flex flex-col md:flex-row md:items-center md:justify-between gap-1 md:gap-2 text-[10px] md:text-xs uppercase tracking-[0.25em] font-semibold text-muted-foreground will-change-transform"
      ...
      >
        ...
        <h1 className="md:hidden font-display uppercase text-foreground leading-[0.82] tracking-[-0.05em] text-left select-none w-full max-w-full">
          ...
          <span className="block text-primary animate-hero-in opacity-0" style={{ fontSize: "clamp(4.5rem, 26vw, 11rem)", animationDelay: "420ms", animationFillMode: "forwards" }}>SHIFT</span>
        </h1>
